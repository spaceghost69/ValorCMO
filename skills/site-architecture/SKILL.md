...
|-----------|--------------|--------------|-------------|
| SaaS marketing | 2-3 levels | Home, Features, Pricing, Blog, Docs | `/features/{feature-name}`, `/blog/{slug}` |
...
| L2 | Section pages | `/features/{feature-name}`, `/blog/{slug}` |
...
| Contextual | Related content within text | "Learn more about [this feature](/features/{feature-name})" |
